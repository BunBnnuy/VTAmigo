...
//
// createAnimationController(injectParam) returns one independent animation
// loop bound to a single VTS connection's injectParam — callers driving
// several separate VTS instances create one controller per instance.

function createAnimationController(injectParam) {
  ...
  return { startThinking, stopThinking, startSpeaking, stopSpeaking };
}
