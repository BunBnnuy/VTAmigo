export default {
  ...
  chatOverlayPanel: {
    ...
    sliceHint: "Corner insets, as a % of the image itself (dashed lines in the preview) — applied to each message individually; the region between them stretches to fill that message.",
    sliceLeft: "Left ({pct}%)",
    sliceRight: "Right ({pct}%)",
    sliceTop: "Top ({pct}%)",
    sliceBottom: "Bottom ({pct}%)",
