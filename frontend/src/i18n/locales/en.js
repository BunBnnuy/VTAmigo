export default {
  ...
  app: {
    ...
    viewersTitle: "Current viewers (updates about every minute while live; last known when offline)",
    sessionTitle: "Stream session length (ticks while live; freezes when offline)",
    liveChat: "Live Chat",
    ...
    achievementUnlocked: "Achievement unlocked: {name} (+{points} pts)",
    achievementMore: "+{count} more",
    tierUpgraded: "Account upgraded to {tier}",
  },
  ...
  achievementsPanel: {
    ...
    points: "{points} pts",
    tier: "Tier: {tier}",
    nextTier: "{tier} tier: {points}/{needed} pts",
    nextTitle: "{tier} tier unlocks at {needed} points",
    ...
    items: {
      first_connect: { name: "First connection", desc: "Connect to your Twitch channel" },
      ai_1: { name: "First words", desc: "Generate your first AI response" },
      ai_20: { name: "Warming up", desc: "Generate 20 AI responses" },
      ai_100: { name: "On a roll", desc: "Generate 100 AI responses" },
      ai_500: { name: "Headliner", desc: "Generate 500 AI responses" },
      chat_100: { name: "Breaking the ice", desc: "See 100 chat messages" },
      chat_1000: { name: "Busy chat", desc: "See 1,000 chat messages" },
      chat_10000: { name: "Chat flood", desc: "See 10,000 chat messages" },
      community_10: { name: "Gathering", desc: "Chat with 10 unique chatters" },
      community_50: { name: "Community", desc: "Chat with 50 unique chatters" },
      first_follow: { name: "First follower", desc: "Get your first recorded follow" },
      first_sub: { name: "First subscriber", desc: "Get your first subscription" },
      first_resub: { name: "Welcome back", desc: "Get your first resubscription" },
      first_giftsub: { name: "Generous crowd", desc: "Get your first gift subscription" },
      first_raid: { name: "Raid party", desc: "Receive your first raid" },
      first_cheer: { name: "Cheers", desc: "Receive your first cheer" },
      first_redeem: { name: "Reward claimed", desc: "Get your first channel-point redemption" },
      link_bot: { name: "Bot handler", desc: "Link your own bot account" },
      avatar_ready: { name: "Face reveal", desc: "Upload both avatar images" },
      overlay_builder: { name: "Set designer", desc: "Create a custom overlay layout" },
      dj_setup: { name: "DJ booth", desc: "Set a default song-request playlist" },
    },
  },
  ...
  shoutoutPanel: {
    title: "Shoutouts",
    copyOverlayTitle: "Copy the shoutout overlay URL for OBS",
    copied: "Copied",
    copyOverlay: "Copy overlay",
    modeSection: "Clip selection",
    modeRecentRandom: "Random clip from the last 30 days",
    modeTopRandom: "Random top clip",
    modeMostRecent: "Latest clip from the last 30 days",
    showBanner: "Show banner",
    bannerTextLabel: "Banner text ({username} = channel)",
    bannerPlaceholder: "Shoutout to {username}!",
    messageBg: "Message background",
    messageColor: "Message text color",
    messageFont: "Message font",
    avatarSection: "Channel icon",
    showAvatar: "Show channel icon",
    avatarShape: "Icon shape",
    avatarShapeCircle: "Circle",
    avatarShapeSquare: "Square",
    testSection: "Test",
    testPlaceholder: "Twitch username (empty = yours)",
    testButton: "Test shoutout",
    testing: "Loading…",
    lastSection: "Last shoutout",
    noShoutout: "No shoutout yet",
    loadError: "Could not load shoutout settings.",
    testError: "Shoutout failed: {error}",
    hint: "Mods and the streamer can trigger this with !so <username>",
  },
