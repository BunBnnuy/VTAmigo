export default {
  ...
  shoutoutPanel: {
    title: "シャウトアウト",
    copyOverlayTitle: "OBS用シャウトアウトオーバーレイのURLをコピー",
    copied: "コピーしました",
    copyOverlay: "オーバーレイをコピー",
    modeSection: "クリップの選択",
    modeRecentRandom: "過去30日間のクリップからランダム",
    modeTopRandom: "人気クリップからランダム",
    modeMostRecent: "過去30日間の最新クリップ",
    showBanner: "バナーを表示",
    bannerTextLabel: "バナーテキスト（{username} = チャンネル名）",
    bannerPlaceholder: "{username} にシャウトアウト！",
    messageBg: "メッセージの背景",
    messageColor: "メッセージの文字色",
    messageFont: "メッセージのフォント",
    avatarSection: "チャンネルアイコン",
    showAvatar: "チャンネルアイコンを表示",
    avatarShape: "アイコンの形",
    avatarShapeCircle: "円形",
    avatarShapeSquare: "四角",
    testSection: "テスト",
    testPlaceholder: "Twitchユーザー名（空欄 = 自分）",
    testButton: "シャウトアウトをテスト",
    testing: "読み込み中…",
    lastSection: "最後のシャウトアウト",
    noShoutout: "まだシャウトアウトはありません",
    loadError: "設定を読み込めませんでした。",
    testError: "シャウトアウトに失敗しました: {error}",
    hint: "モデレーターと配信者は !so <ユーザー名> で実行できます",
  },
