export default {
  ...
  shoutoutPanel: {
    title: "셔아웃",
    copyOverlayTitle: "OBS용 셔아웃 오버레이 URL 복사",
    copied: "복사됨",
    copyOverlay: "오버레이 복사",
    modeSection: "클립 선택",
    modeRecentRandom: "최근 30일 내 클립 중 무작위",
    modeTopRandom: "인기 클립 중 무작위",
    modeMostRecent: "최근 30일 내 최신 클립",
    showBanner: "배너 표시",
    bannerTextLabel: "배너 텍스트 ({username} = 채널명)",
    bannerPlaceholder: "{username}님 셔아웃!",
    messageBg: "메시지 배경",
    messageColor: "메시지 글자색",
    messageFont: "메시지 글꼴",
    avatarSection: "채널 아이콘",
    showAvatar: "채널 아이콘 표시",
    avatarShape: "아이콘 모양",
    avatarShapeCircle: "원형",
    avatarShapeSquare: "사각형",
    testSection: "테스트",
    testPlaceholder: "Twitch 사용자 이름 (비우면 본인)",
    testButton: "셔아웃 테스트",
    testing: "불러오는 중…",
    lastSection: "마지막 셔아웃",
    noShoutout: "아직 셔아웃이 없습니다",
    loadError: "설정을 불러오지 못했습니다.",
    testError: "셔아웃 실패: {error}",
    hint: "모더레이터와 스트리머가 !so <사용자명>으로 실행할 수 있습니다",
  },
