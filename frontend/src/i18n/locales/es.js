export default {
  ...
  shoutoutPanel: {
    title: "Shoutouts",
    copyOverlayTitle: "Copiar la URL del overlay de shoutout para OBS",
    copied: "Copiado",
    copyOverlay: "Copiar overlay",
    modeSection: "Selección de clip",
    modeRecentRandom: "Clip aleatorio de los últimos 30 días",
    modeTopRandom: "Clip popular aleatorio",
    modeMostRecent: "Clip más reciente de los últimos 30 días",
    showBanner: "Mostrar banner",
    bannerTextLabel: "Texto del banner ({username} = canal)",
    bannerPlaceholder: "¡Shoutout a {username}!",
    messageBg: "Fondo del mensaje",
    messageColor: "Color del texto",
    messageFont: "Fuente del mensaje",
    avatarSection: "Icono del canal",
    showAvatar: "Mostrar icono del canal",
    avatarShape: "Forma del icono",
    avatarShapeCircle: "Círculo",
    avatarShapeSquare: "Cuadrado",
    testSection: "Prueba",
    testPlaceholder: "Usuario de Twitch (vacío = el tuyo)",
    testButton: "Probar shoutout",
    testing: "Cargando…",
    lastSection: "Último shoutout",
    noShoutout: "Aún no hay shoutout",
    loadError: "No se pudo cargar la configuración.",
    testError: "Falló el shoutout: {error}",
    hint: "Los mods y el streamer pueden activarlo con !so <usuario>",
  },
