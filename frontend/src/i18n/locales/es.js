export default {
  ...
  chatOverlayPanel: {
    ...
    sliceHint: "Márgenes de esquina, como % de la propia imagen (líneas punteadas en la vista previa) — se aplican a cada mensaje individualmente; la región entre ellos se estira para llenar ese mensaje.",
    sliceLeft: "Izquierda ({pct}%)",
    sliceRight: "Derecha ({pct}%)",
    sliceTop: "Arriba ({pct}%)",
    sliceBottom: "Abajo ({pct}%)",
